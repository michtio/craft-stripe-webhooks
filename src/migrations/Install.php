...
class Install extends Migration
{
   ...
   /**
    ...
    protected function createTables()
    {
        ...
        $tableSchema = Craft::$app->db->schema->getTableSchema('{{%stripewebhooks_stripewebhookcall}}');
        if ($tableSchema === null) {
            $tablesCreated = true;
            $this->createTable(
    ...
    {
        $this->addForeignKey(
            $this->db->getForeignKeyName('{{%stripewebhooks_stripewebhookcall}}', 'siteId'),
            '{{%stripewebhooks_stripewebhookcall}}',
            'siteId',
            '{{%sites}}',
            'id',
    ...
    {
        $this->dropTableIfExists('{{%stripewebhooks_stripewebhookcall}}');
    }
}
